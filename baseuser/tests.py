...
class TestBaseUsersAPIViewSet(TestCase):
    ...
    def setUpTestData(cls):
        ...
        BaseUsers.objects.create(username='name1', password1='name1',password2='name1', email='name1@gmail.com', date_created=datetime.date.fromisocalendar,django_user=django_user)
