...
class TestSurveyAPIViewSet(TestCase):
    ...
    def setUpTestData(cls):
        ...
        django_user2 = User.objects.create_user(
            username='name2', password='name2', email='name2@gmail.com')
        ...
        user2 = BaseUsers.objects.create(
            username='name2', password1='name2', password2='name2',
    ...
    def setUp(self):
        ...
        #print(f'updatedTest data - {response.data}')
